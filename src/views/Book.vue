<template>
  <div class="about">
    ...
    <v-card-media v-if="book.cover" :src="getImage('/'+book.cover)" height="200px"></v-card-media>

    <v-subheader> Information </v-subheader>
    <table class="v-table">
      <tbody>
      <tr><th class="text-xs-left">Author</th><td>{{ book.author }}</td></tr>
      ...
      <tr><th class="text-xs-left">Weight</th><td>{{ book.weight }} kg</td></tr>
